...
def main():
    ...
    IPC_dir = os.path.join(args.output_dir, 'IPC-Classification')
    if not os.path.exists(IPC_dir):
        os.makedirs(IPC_dir)

    if os.path.exists(f'{IPC_dir}/train_512.csv') and os.path.exists(f'{IPC_dir}/test_512.csv'):
        print("IPC dataset already created!")
        # read csv files
        train_dataset = pd.read_csv(f'{IPC_dir}/train_512.csv')
        test_dataset = pd.read_csv(f'{IPC_dir}/test_512.csv')
        ...
        # IPC classification and KNN
        train_file_path = './patentmap_eval/data/downstream/IPC-Classification/train_512.csv'
        test_file_path = './patentmap_eval/data/downstream/IPC-Classification/test_512.csv'
        ...
        train_dataset.to_csv(os.path.join(IPC_dir, 'train_512.csv'), index=False)
        test_dataset.to_csv(os.path.join(IPC_dir, 'test_512.csv'), index=False)
